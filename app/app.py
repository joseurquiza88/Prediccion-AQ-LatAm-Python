...
if TEMPORAL_FILE.exists():
    ...
    print(
        "Creando serie temporal a partir de los TIFF...")
...
def mostrar_pixel(
    ...
    if registro.empty:
        ...
        return (
            ...
            "No se encontró el mapa seleccionado.",
...
# =========================================================
# CALLBACK - SERIE TEMPORAL CIUDAD
# =========================================================
...
def actualizar_serie_temporal(
    ciudad
):

    datos = serie_temporal[

        serie_temporal["ciudad"]
        == ciudad
        ...
        figura.update_layout(
            ...
            annotations=[
                ...
                dict(
                    ...
                    text=
                        "Hacé click sobre el mapa para seleccionar un píxel",
